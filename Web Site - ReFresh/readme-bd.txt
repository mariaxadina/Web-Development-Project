...
CREATE USER maria WITH ENCRYPTED PASSWORD 'mariaadina#22';
GRANT ALL PRIVILEGES ON DATABASE cti_2024 TO maria ;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO maria;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO maria;